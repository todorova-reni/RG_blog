...
<div class="edit col-md-12">
    ...
    <table class="table custom">
        ...
        <tr>
            ...
            <td><input type="text" name="author" id="author" placeholder="Post`s author here..." maxlength="30" required
                       value="<?php if (isset( $post )) {
                           echo $post->author;
                       } else echo set_value( 'author' ); ?>"></td>
        </tr>
        <tr>
            <th><label for="date">Date:</label></th>
            <td><input type="text" name="date" id="date" value="<?php echo date( "Y-m-d H:i" ) ?>" required
                       value="<?php if (isset( $post )) {
                           echo $post->date;
                       } else echo set_value( 'date' ); ?>"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="file" name="pic" id="pic" required value="<?php if (isset( $post )) {
                    echo $post->picture;
